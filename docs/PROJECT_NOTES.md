...
- `shared.services` — бизнес-логика (аккаунты, grids, расписания, события, конфиги действий сеток).
- `shared.storage` — слой доступа к БД (инициализация, запросы, конфиги действий сеток).
